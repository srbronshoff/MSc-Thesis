...
if multi_step == True:
    ...
    df_BTC_4hourly= pd.read_csv('empirical_data/4-hour/BTC.csv')
    ...
    df_BTC_8hourly= pd.read_csv('empirical_data/8-hour/BTC.csv')
    ...
    df_8hourly_extension= pd.read_csv('empirical_data/8-hour/BTC.csv')
